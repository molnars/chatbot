...
import os
from streamlit_components import (data_extractor, setting_setup, search_ai, logo_heading,
                                  usage_report, prompt_edit, set_png_as_page_bg)
        ...
        'items': {
            ...
            'AI Powered Knowledge Agent' : {
                        ...
                        'submenu': {
                            'title': "",
                            'items': {
                                'AI Powered Knowledge Agent' : {'action': search_ai, 'item_icon': 'search', 'submenu': None}
                            },
                            'menu_icon': 'None',
                            'default_index': 0,
                            'with_view_panel': 'main',
